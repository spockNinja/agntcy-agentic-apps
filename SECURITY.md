...
The `agentic-apps` maintainers take all security issues in the project
seriously. Thank you for improving the security of `agentic-apps`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`agentic-apps` leverages GitHub's private vulnerability reporting.
